...
{
    public partial class initial_migration_5 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatFileLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_chatGroupHDs_AspNetUsers_ApplicationUserId1",
                        column: x => x.ApplicationUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_chatGroupHDs_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_chatGroupHDs_StudentGroupDetails_StudentGroupDetailId",
                        column: x => x.StudentGroupDetailId,
                        principalTable: "StudentGroupDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_chatGroupHDs_StudentGroupHDs_StudentGroupHDId",
                        column: x => x.StudentGroupHDId,
                        principalTable: "StudentGroupHDs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatGroupDetails_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatGroupDetails_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatGroupDetails_StudentGroupDetails_StudentGroupDetailId",
                        column: x => x.StudentGroupDetailId,
                        principalTable: "StudentGroupDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatGroupDetails_StudentGroupHDs_StudentGroupHDId",
                        column: x => x.StudentGroupHDId,
                        principalTable: "StudentGroupHDs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatGroupDetails_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatGroupDetails_UserRoles_UserRoleId",
                        column: x => x.UserRoleId,
                        principalTable: "UserRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatGroupDetails_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatGroupDetails_CourseId",
                table: "ChatGroupDetails",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatGroupDetails_StudentGroupDetailId",
                table: "ChatGroupDetails",
                column: "StudentGroupDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatGroupDetails_StudentGroupHDId",
                table: "ChatGroupDetails",
                column: "StudentGroupHDId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatGroupDetails_SubjectId",
                table: "ChatGroupDetails",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatGroupDetails_UserRoleId",
                table: "ChatGroupDetails",
                column: "UserRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_chatGroupHDs_ApplicationUserId1",
                table: "chatGroupHDs",
                column: "ApplicationUserId1");

            migrationBuilder.CreateIndex(
                name: "IX_chatGroupHDs_CourseId",
                table: "chatGroupHDs",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_chatGroupHDs_StudentGroupDetailId",
                table: "chatGroupHDs",
                column: "StudentGroupDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_chatGroupHDs_StudentGroupHDId",
                table: "chatGroupHDs",
                column: "StudentGroupHDId");
